...
5. [Plugin Manifest (`manifest.master.yml`)](#plugin-manifest-manifestmasteryml)
...
8. [The Main Script (`server/webhook/register-doi.js`)](#the-main-script-serverwebhookregister-doijs)
   - [Top-level structure](#top-level-structure)
   - [`main()`](#main)
   - [`resolveFieldPathAsync()`](#resolvefieldpathasync)
   - [`getNestedValue()`](#getnestedvalue)
   - [`httpRequest()`](#httprequest)
9. [DataCite API Integration](#datacite-api-integration)
